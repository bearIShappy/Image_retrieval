...
# 1. Write DatasetOverview.tsx
overview_content = """import { useState, useEffect, useCallback } from 'react';
...
with open("src/frontend/src/components/DatasetOverview.tsx", "w", encoding="utf-8") as f:
    f.write(overview_content)

# 2. Update App.tsx imports and usages
app_file = "src/frontend/src/App.tsx"
...
print("Created DatasetOverview.tsx and updated App.tsx")
